This manuscript
(\href{https://lubianat.github.io/quali_phd/v/6be5c637bc2c3d7dcaab4728fbb4091baf10abbf/}{permalink})
was automatically generated
from \href{https://github.com/lubianat/quali_phd/tree/6be5c637bc2c3d7dcaab4728fbb4091baf10abbf}{lubianat/quali\_phd@6be5c63}
on December 2, 2021.
...
\hypertarget{cell-disease-network-analysis}{%
\subsubsection{Cell-disease network analysis}\label{cell-disease-network-analysis}}
...
We avoided the dissection of the differences between persistent classes of cells (often called ``cell types'') or the transient, fugacious classes of cells (often called ``cell states'') (see ``Definition of cell identity'' section in {[}\protect\hyperlink{ref-pFijpXkl}{122}{]} for an example).
...
To facilitate communication among life scientists, in a preprint derived from this PHD project{[}\protect\hyperlink{ref-uCE45Jh8}{123}{]}, we proposed, among other theoretical novelties, naming conventions for different cell types classes.
...
It is useful to distill these different concepts into names. Given the importance of the species' concept in biological classification {[}\protect\hyperlink{ref-AHGRV6KQ}{124}{]}, we derive a species-centric view on the naming of classes of cell types.
...
By ``class'' we mean an abstract entity in the sense intended by the multilevel theory of conceptual modelling (referred as ``\emph{types}'' by Carvalho et al.~) {[}\protect\hyperlink{ref-eP47FILn}{125}{]}
...
\centering
\includegraphics[width=1\textwidth,height=\textheight]{https://raw.githubusercontent.com/lubianat/multilevel_ontology_drawings/master/combination_human_cell.png}
...
PanglaoDB {[}\protect\hyperlink{ref-M0lqRYJb}{126}{]} {[}\protect\hyperlink{ref-T3PlZ3Vh}{127}{]} is a publically-available database that contains data and metadata on hundreds of single-cell RNA sequencing experiments.
...
As of August 2020, Wikidata had 264 items being categorized as a ``cell type'', considerably less than in specialized cell catalogs, which count over two thousand cell types {[}\protect\hyperlink{ref-agnqfdk6}{45},\protect\hyperlink{ref-4AEy2xhQ}{129}{]}.
...
\includegraphics{images/poster_ISCB_intro}
...
\centering
\includegraphics{images/chat_marker.png}
...
federated queries with other biological databases, such as Uniprot {[}\protect\hyperlink{ref-HUJ9NzAb}{130}{]}
and Wikipathways {[}\protect\hyperlink{ref-AgOOCR24}{131}{]}.
...
\centering
\includegraphics{images/poster_ISCB_results.png}
...
\item
  Develop a professional way for coverage of large-scale revisions, inspired by Umberto Eco's How to Write a Thesis {[}\protect\hyperlink{ref-1HBVPtZGp}{121}{]} adapted to the digital environment, using version-control and semantic links.
\item
